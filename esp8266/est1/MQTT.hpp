...
const char* MQTT_USERPASS = "XXXXXX";
const char* MQTT_CLIENT_NAME = "ESP8266_est1";


const char* MQTT_TOPIC_TEMP = "est1/temperature";
const char* MQTT_TOPIC_HUMI = "est1/humidity";
const char* MQTT_TOPIC_UV = "est1/uv";
